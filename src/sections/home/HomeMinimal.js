...
const CARDS = [
  ...
  },
  {
    ...
    description: 'Hindari human-error serta proses manual yang memakan waktu dan biaya.',
  },
  {
    icon: '/logo/clouds.svg',
    title: 'Tersimpan di cloud',
    description: 'Akses seluruh data penting dengan mudah, di mana saja dan kapan saja.',
  },
];
      ...
      <Container component={MotionViewport}>
        ...
        >
          ...
          <m.div variants={varFade().inDown}>
            <Typography variant="h2">Optimalkan proses bisnis</Typography>
          </m.div>
        </Box>
